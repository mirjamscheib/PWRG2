...
# 3. Safe calculated Indices for application in Point 2.
```{r}
#WUA Tanno 2012 Baetis sp. winter (velocity + water depth)
WUA_Tanno_2012_Baetis_sp <- WUA
HHS_Tanno_2012_Baetis_sp <- HHS

# WUA Tanno 2012 Rhithrogena winter (velocity + water depth)
WUA_Tanno_2012_Rhithrogena_sp <- WUA
HHS_Tanno_2012_Rhithrogena_sp <- HHS
```
...
```{r}
# Wie aendert sich die Habitatverfuegbarkeit in Abhaengigkeit vom Abfluss?  
# Wiederholen Sie die Berechnung der Indizes (siehe 1.) fuer dieselben Projektvariante  
# und Altersklasse aber mit einem anderen Abfluss.

#Plot - WUA vs. Abfluss
# Tanno 2012: Rhithrogena 
WUA_Tanno_2012_Rhithrogena <- plot(c(3.9, 4.6, 7, 11.4, 13.3, 32.69), c(WUA_Tanno_2012_Rhithrogena_3, WUA_Tanno_2012_Rhithrogena_4, WUA_Tanno_2012_Rhithrogena_7, WUA_Tanno_2012_Rhithrogena_11, WUA_Tanno_2012_Rhithrogena_13, WUA_Tanno_2012_Rhithrogena_32), main = "Weighted Usable Area (WUA) - Tanno 2012: Rhithrogena",
     xlab = "Discharge [m/s]", ylab = expression(m^2), type = "l")

# HABBY Rhithrogena 
WUA_HABBY_Rhithrogena <- plot(c(3.9, 4.6, 7, 11.4, 13.3, 32.69), c(WUA_HABBY_Rhithrogena_3, WUA_HABBY_Rhithrogena_4, WUA_HABBY_Rhithrogena_7, WUA_HABBY_Rhithrogena_11, WUA_HABBY_Rhithrogena_13, WUA_HABBY_Rhithrogena_32), main = "Weighted Usable Area (WUA) - HABBY: Rhithrogena",
     xlab = "Discharge [m/s]", ylab = expression(m^2), type = "l")

# Tanno 2012: Baetis sp.  
WUA_Tanno_2012_Baetis <- plot(c(3.9, 4.6, 7, 11.4, 13.3, 32.69), c(WUA_Tanno_2012_Baetis_3, WUA_Tanno_2012_Baetis_4, WUA_Tanno_2012_Baetis_7, WUA_Tanno_2012_Baetis_11, WUA_Tanno_2012_Baetis_13, WUA_Tanno_2012_Baetis_32), main = "Weighted Usable Area (WUA) - Tanno 2012: Baetis sp.",
     xlab = "Discharge [m/s]", ylab = expression(m^2), type = "l")

#Plot - HHS vs. Abfluss
# Tanno 2012: Rhithrogena 
HHS_Tanno_2012_Rhithrogena <- plot(c(3.9, 4.6, 7, 11.4, 13.3, 32.69), c(HHS_Tanno_2012_Rhithrogena_3, HHS_Tanno_2012_Rhithrogena_4, HHS_Tanno_2012_Rhithrogena_7, HHS_Tanno_2012_Rhithrogena_11, HHS_Tanno_2012_Rhithrogena_13, HHS_Tanno_2012_Rhithrogena_32), main = "HHS - Tanno 2012: Rhithrogena",
     xlab = "Discharge [m/s]", ylab = expression(m^2), type = "l")

# HABBY: Rhithrogena 
HHS_HABBY_Rhithrogena <- plot(c(3.9, 4.6, 7, 11.4, 13.3, 32.69), c(HHS_HABBY_Rhithrogena_3, HHS_HABBY_Rhithrogena_4, HHS_HABBY_Rhithrogena_7, HHS_HABBY_Rhithrogena_11, HHS_HABBY_Rhithrogena_13, HHS_HABBY_Rhithrogena_32), main = "HHS - HABBY: Rhithrogena",
     xlab = "Discharge [m/s]", ylab = expression(m^2), type = "l")

# Tanno 2012: Baetis sp.  
HHS_Tanno_2012_Baetis <- plot(c(3.9, 4.6, 7, 11.4, 13.3, 32.69), c(HHS_Tanno_2012_Baetis_3, HHS_Tanno_2012_Baetis_4, HHS_Tanno_2012_Baetis_7, HHS_Tanno_2012_Baetis_11, HHS_Tanno_2012_Baetis_13, HHS_Tanno_2012_Baetis_32), main = "HHS - Tanno 2012: Baetis sp.",
     xlab = "Discharge [m/s]", ylab = expression(m^2), type = "l")
```

```{r}
# make data frame for plotting
WUA_Tanno_2012_Rhithrogena_df <- data.frame(Discharge = c(3.9, 4.6, 7, 11.4, 13.3, 32.69), WUA_Tanno_Rhithrogena = c(WUA_Tanno_2012_Rhithrogena_3, WUA_Tanno_2012_Rhithrogena_4, WUA_Tanno_2012_Rhithrogena_7, WUA_Tanno_2012_Rhithrogena_11, WUA_Tanno_2012_Rhithrogena_13, WUA_Tanno_2012_Rhithrogena_32), WUA_HABBY_Rhithrogena = c(WUA_HABBY_Rhithrogena_3, WUA_HABBY_Rhithrogena_4, WUA_HABBY_Rhithrogena_7, WUA_HABBY_Rhithrogena_11, WUA_HABBY_Rhithrogena_13, WUA_HABBY_Rhithrogena_32))

ggplot(WUA_Tanno_2012_Rhithrogena_df, aes(Discharge, WUA_HABBY_Rhithrogena)) +
  geom_line(lty = 4, lwd = 1.5, col = "blue") + 
  theme_minimal()
```

```{r}
# WUA 
ggsave(filename = "results_statistics/WUA_Tanno_2012_Rhithrogena.png",plot = WUA_Tanno_2012_Rhithrogena)

ggsave(filename = "results_statistics/WUA_HABBY_Rhithrogena.png",plot = WUA_HABBY_Rhithrogena)

ggsave(filename = "results_statistics/WUA_Tanno_2012_Baetis.png",plot = WUA_Tanno_2012_Baetis)

# HHS
ggsave(filename = "results_statistics/HHS_Tanno_2012_Rhithrogena.png",plot = HHS_Tanno_2012_Rhithrogena)

ggsave(filename = "results_statistics/HHS_HABBY_Rhithrogena.png",plot = HHS_HABBY_Rhithrogena)

ggsave(filename = "results_statistics/HHS_Tanno_2012_Baetis.png",plot = HHS_Tanno_2012_Baetis)
```
