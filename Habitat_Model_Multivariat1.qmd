...
# HHS results
HHS_results <- ggplot() +
  geom_line(data = HHS_Tanno_2012_Baetis, aes(Discharge, HHS, color = "HHS_Tanno_Baetis"), linetype = "dashed", size = 1.5) +
  geom_line(data = HHS_Tanno_2012_Rhithrogena, aes(Discharge, HHS, color = "HHS_Tanno_Rhithrogena"), linetype = "dashed", size = 1.5) +
   geom_line(data = HHS_HABBY_Rhithrogena, aes(Discharge, HHS, color = "HABBY_Rhithrogena"), linetype = "dashed", size = 1.5) +
   scale_color_manual(name = "Macroinvertebrates",
...
WA_tot_results <- ggplot() +
  geom_line(data = WA_Tanno_2012_Baetis, aes(Discharge, WA_tot, col = "blue"), linetype = "dashed", size = 1.5) +
