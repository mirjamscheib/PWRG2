...
WUA_long <- pivot_longer(WUA_HHS, cols = c(3:7), names_to = "attribute", values_to = "value")

# Define a custom labelling function
my_labeller <- function(variable, value) {
  if (variable == "WUA") {
    return(c("WUA_normal" = "WUA", "WUA_pers" = "WUA persistent habitat", "VZH" = "FOEN")[value])
  } 
}
...
ggplot(WUA_long, aes(Discharge, value, col = attribute)) +
  facet_wrap(Description~value, labeller = my_labeller) +
  geom_line(lwd = 0.8) +
  geom_point(size = 2) +
...
share_VZH <- ggplot(join_long, aes(attribute, area, fill = classes)) +
  ...
  labs(x = "", y = "Share") +
  ggtitle("Comparing the Share of Flow Velocity Classes between Scenarios") +
  labs(fill = "Flow velocity classes") +
