...
my_labeller <- function(variable, value) {
  if (variable == "WUA") {
    return(c("WUA_normal" = "WUA", "WUA_pers" = "WUA persistent habitat", "VZH")[value])
  } 
}
...
ggplot(WUA_long, aes(Discharge, value, col = WUA)) +
...
# bind together 
join <- left_join(freq_VZH_2, freq_VZH_9, by = "value")

join <- left_join(join, freq_VZH_pers_9, by = "value")
