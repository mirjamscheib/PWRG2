...
ggplot(WUA_HHS, aes(Discharge, WUA_normal, col = Description)) +
  ...
  geom_point() +
  geom_line() +
  labs(title = "Comparing WUA of different macroinvertebrates and literature", x = expression(paste("Discharge [", m^3/s, "]")), y = "Weighted usable area (WUA)") 

# Plot WUA ALL  -----------------------------------
ggplot(WUA_long, aes(Discharge, value, col = Description)) +
  facet_wrap(WUA~Description, ncol = 3, nrow = 3) +
  geom_point() +
  geom_line() +
  labs(title = "Comparing WUA of different macroinvertebrates and literature", x = expression(paste("Discharge [", m^3/s, "]")), y = "Weighted usable area (WUA)") +
  theme_minimal()
...
ggplot() +
  ...
  labs(title = "Comparing HHS of different macroinvertebrates and literature", x = expression(paste("Discharge [", m^3/s, "]")), y = "HHS")
```
